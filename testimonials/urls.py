...
urlpatterns = [
    ...
    path('approve_testimonial/<int:testimonial_id>/', views.approve_testimonial, name='approve_testimonial'),
    path('delete_testimonial/<int:testimonial_id>/', views.delete_testimonial, name='delete_testimonial'),
    path('not_approved_testimonials/', views.view_not_approved_testimonials, name='not_approved_testimonials'),
]